...
The artifact is citable via ... 

The Cadence Simulator provides a framework to test decentralized message passing algorithms on mobility datasets. For additional info, see [README.md](README.md).
