...
func (rwl *RandomWalkLogicV1) HandleHelper(config *model.Config, encounter *model.Encounter, messageMap1 *sync.Map, messageMap2 *sync.Map, nodeid1 model.NodeId, nodeid2 model.NodeId) (float32, float32) {
...
func (rwl *RandomWalkLogicV1) HandleEncounter(config *model.Config, encounter *model.Encounter) (float32, float32) {
...
// data preparation
func (rwl *RandomWalkLogicV1) DataPreparation(rows *sql.Rows, logg *logger.Logger, minevents int, config *model.Config) (*sync.Map, []model.NodeId) {
